...
function transactionReport($wsRequest)
{
  try{
    ...
    $providerId = $wsRequest->getParam("providerId", "0");
    ...
    $appManager = new AppManager();
    $dataReport = $appManager->transactionReport($providerId, $statusList, $transactionType, $agencyType, $agencyList, $account->getAccountId(), $companyId, $beginDate, $endDate, $controlNumber, $username, $transactionId, $merchantTransId, 0);
